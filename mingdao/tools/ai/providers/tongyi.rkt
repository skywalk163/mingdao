...
(define path "/compatible-mode/v1/chat/completions")
(define default-model "qwen-turbo")
(define models '("qwen-turbo" "qwen-plus" "qwen-max"))
...
(module+ main
  (writeln (list 'tongyi '支持的模型: (支持的模型))))
